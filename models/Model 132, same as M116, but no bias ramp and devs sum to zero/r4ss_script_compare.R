...
library(r4ss)
model.dir <- "Model 132, same as M116, but no bias ramp and devs sum to zero"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 131, same as M116, but no bias ramp"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 117, change summary bio to age 1+ for historical comparison"
dir4 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 134, M116 with age 1+ SumBio and sum(devs) is zero"
...
legend.labels <- c("M132 no bias, sum(devs)=0", "M131 no bias, sum(devs)!=0", "M116 pre-STAR base with age 1+ sumbio", "M116 sum(devs)=0")
