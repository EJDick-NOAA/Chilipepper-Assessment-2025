...
library(r4ss)
model.dir <- "Model 177, set female M = male M with M167"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 167, proposed base model, Friday AM"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 172, estimate h with M167"
...
legend.labels <- c("h=0.72, female M = male M", "h=0.72, sex-specific M (base)", "est.h, sex-specific M")
