...
#
4 #_Nblock_Patterns
2 1 1 1 #_blocks_per_pattern 
# begin and end years of blocks
# Time Block Pattern #1
1875 1990 1991 1999 # bocaccio rockfish comm. sort requirement in 1991 (bocaccio frequently landed with chilipepper); PLUS shelf closure
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 ...
 0.01    12      5       5       99      0       3       0       0       0        0        0      4      2        #  DN Descending Scale
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Init
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Final
...
#LO     HI      INIT    PRIOR   PR_SD   PR_type PHASE	#Parm name
 8.5     59.5   30     30      99      0       3	    # NoCA_HKL PEAK, block pattern 1 (1875-1990); pre-boc sort
 8.5     59.5   30     30      99      0       3	    # NoCA_HKL PEAK, block pattern 1 (1991-1999); boc sort to shelf closure
 0.5    15      3      3       99      0       3	    # NoCA_HKL ASCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
 0.5    15      3      3       99      0       3	    # NoCA_HKL ASCENDING SCALE, block pattern 1 (1991-1999); boc sort to shelf closure
 0.5    15      10     5       99      0      -3	    # NoCA_HKL DESCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
...
#factor fleet New_Var_adj hash Old_Var_adj New_Francis   New_MI Francis_mult Francis_lo Francis_hi  MI_mult Type             Name                              Note
      4     1    0.632487    #    0.628309    0.632487 1.398206     1.006649   0.712674   1.672132 2.225348  len         NoCA_HKL                                  
      4     2    1.000000    #    1.000000    2.320811 6.111812     2.320811   1.732155   4.107464 6.111812  len         SoCA_HKL                                  
      4     3    0.220951    #    0.223081    0.220951 0.591120     0.990454   0.674792   1.638752 2.649799  len           CA_TWL                                  
      4     4    0.112051    #    0.093134    0.112051 0.383213     1.203119   0.713670   4.269032 4.114646  len       OR_WA_Comm                                  
      4     5    0.426330    #    0.427889    0.426330 1.627499     0.996357   0.574719   2.682678 3.803553  len           CA_NET                                  
      4     6    0.703902    #    0.697783    0.703902 0.582421     1.008769   0.755992   1.489355 0.834674  len   NoCA_OR_WA_Rec                                  
      4     7    0.159648    #    0.159545    0.159648 0.616012     1.000645   0.646331   1.792239 3.861055  len         SoCA_Rec                                  
      4     8    0.020792    #    0.021040    0.020792 0.067637     0.988201   0.635807   3.031234 3.214679  len      TWL_discard                                  
      4     9    0.037683    #    0.037213    0.037683 0.139721     1.012635   0.684212   2.041098 3.754635  len     WCGBT_Survey                                  
      4    10    0.054512    #    0.052611    0.054512 0.169885     1.036129   0.719404   3.821231 3.229083  len Triennial_Survey                                  
      5     1    0.037095    #    0.036865    0.037095 0.147554     1.006249   0.472318   6.459846 4.002540  age         NoCA_HKL                                  
      5     3    0.020216    #    0.020320    0.020216 0.022813     0.994878   0.582193   2.552912 1.122683  age           CA_TWL                                  
      5     4    1.000000    #    1.000000    8.249408 0.414863     8.249408   6.152735  47.091249 0.414863  age       OR_WA_Comm                                  
      5     5    0.074493    #    0.074530    0.074493 0.162469     0.999506   0.622561   3.200064 2.179916  age           CA_NET                                  
      5     6    1.000000    #    1.000000    1.878563 0.564409     1.878563   1.878563        Inf 0.564409  age   NoCA_OR_WA_Rec                                  
      5     9    0.087554    #    0.089064    0.087554 0.006372     0.983043   0.601372   3.031849 0.071542  age     WCGBT_Survey                                  
      5    10    0.116106    #    0.116012          NA 0.116106           NA         NA         NA 1.000809  age Triennial_Survey No Francis weight--using MI value
-9999  0  0   #  terminator
#
7 #_maxlambdaphase
