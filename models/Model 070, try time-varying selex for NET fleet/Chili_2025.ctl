...
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 0.01    12      3       3       99      0       3       0       0       0        0        0      1      2        #  DN Ascending Scale
 0.01    20      15      15      99      0       3       0       0       0        0        0      1      2        #  DN Descending Scale
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Init
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Final
# NoCA_OR_WA_Rec
...
#LO     HI      INIT    PRIOR   PR_SD   PR_type PHASE	#Parm name
 ...
 10     59      30     30      99      0       3	    # CA_NET PEAK, block pattern 1 (1875-1990); pre-boc sort
 0.01   12      3      3       99      0       3	    # CA_NET ASCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
 0.01   20      15     15      99      0       3	    # CA_NET DESCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
