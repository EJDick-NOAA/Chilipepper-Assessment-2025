...
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Init
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Final
# CA_TWL; try 2-D AR selex
  9      59      25      25      99      0      3       0       0       0        0        0      0      0        #  Inflection
  1      30      5       5       99      0      3       0       0       0        0        0      0      0        #  95% width
...
#
########
# try 2D selectivity devs (relaxes separability assumption) on trawl fleet
########
1   #  use 2D_AR1 selectivity(0/1)
# fleet Ymin Ymax LminBinIndex LmaxBinIndex SigmaLmax UseRho DevType Phase BeforeRange AfterRange
  3     1978 2024 10           38           -1        0      1       6     0           0
# parm lines for 2D_AR1 selex
 0.1     2    1     1     99      0      -3	    # sigma_selex at Lmin (fixed at 1 for all size bins)
