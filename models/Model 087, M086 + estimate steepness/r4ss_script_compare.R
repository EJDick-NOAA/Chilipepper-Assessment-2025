...
library(r4ss)
model.dir <- "Model 086, tune comps and est hessian for M085"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 085, block trawl based on 2D results"
...
legend.labels <- c("Block Trawl 2000 Tuned", "Block Trawl 2000", "Domed Net Selex", "M083 (M066 with h=0.72)", "M066")
