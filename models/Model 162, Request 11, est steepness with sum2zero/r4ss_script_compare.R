...
library(r4ss)
model.dir <- "Model 162, Request 11, est steepness with sum2zero"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 161, Request 11, est steepness without sum2zero"
#dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 160, STARbase, asymptotic"
...
legend.labels <- c("Est. Steepness, sum=0", "Est. Steepness, simple devs") #, "Steepness=0.72, simple devs")
