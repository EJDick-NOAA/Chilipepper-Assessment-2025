...
library(r4ss)
model.dir <- "Model 100, PRE-STAR BASE hess step"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 097, penultimate pre-STAR base, run hess_step"
...
legend.labels <- c("Pre-STAR base", "Local Min.")
