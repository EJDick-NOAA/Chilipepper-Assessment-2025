...
# length-at-age; fixing female length at age 0 to roughly mean size of YOY in July; fixing CV(a=0) at 0.1; see regression of CV(L) vs. age
  ...
  42   56   48          48          50    0       2    0            0        0         0         0      0     0         # L_at_Amax_Fem_GP_1
0.10   0.25 0.18        0.20        50    0       2    0            0        0         0         0      0     0         # VonBert_K_Fem_GP_1
0.01   1    0.1         0           50    0       2    0            0        0         0         0      0     0         # SD_young_Fem_GP_1
0.01   1    0.1         0           50    0       2    0            0        0         0         0      0     0         # SD_old_Fem_GP_1
...
#
  -1   1    0.2         0           50    0       2    0            0        0         0         0      0     0         # NatM_p_1_Mal_GP_1
# length-at-age; L(a=0) and CV(L(a=0)) fixed equal to female for YOYs                               
  ...
  -0.5 1.5  0.3         0           50    0       2    0            0        0         0         0      0     0         # VonBert_K_Mal_GP_1
  -2   2    0           0           50    0       2    0            0        0         0         0      0     0         # SD_young_Mal_GP_1
  -2   2    0           0           50    0       2    0            0        0         0         0      0     0         # SD_old_Mal_GP_1
# weight-length from WCGBTS survey data
...
8      12     11     10      5      0        1      0        0        0         0         0       0      0       # SR_LN(R0)
0.201  0.999  0.72   0.72    0.16   2       -5      0        0        0         0         0       0      0       # SR_BH_steep
0      1      0.6    0.6     1      0       -99     0        0        0         0         0       0      0       # SR_sigmaR
...
1 #do_recdev:  0=none; 1=devvector; 2=simple deviations
 ...
 1968.456 #_last_early_yr_nobias_adj_in_MPD                   
 1978.549 #_first_yr_fullbias_adj_in_MPD                      
     2024 #_last_yr_fullbias_adj_in_MPD; ### keep at last year if using YOY index
     2025 #_first_recent_yr_nobias_adj_in_MPD ### keep at last year+1 if using YOY index
    0.764 #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models)
...
#   0   2     0.5   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_Comm_TWL_Logbook
 ...
 -10   0    -5     0       1       0         -1      0         0         0          0          0        0       0       # ln_q_CalCOFI_Survey
   0   2     0.4   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_CalCOFI_Survey
#
...
#  1      10      2       2       99      0      3       0       0       0        0        0      0      0        #  95% width
 10      59      30      30      99      0       3       0       0       0        0        0.5    0      0        #  DN Peak
-10      10     -6      -6       99      0      -3       0       0       0        0        0.5    0      0        #  DN Top
 0.5     8       3       3       99      0       3       0       0       0        0        0.5    0      0        #  DN Ascending Scale
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0.5    0      0        #  DN Top
 0.5     8       3       3       99      0       3       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 1       8       7       7       99      0      -3       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -9      -10     -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0      -3       0       0       0        0        0      0      0        #  DN Final
# OR_WA_Comm
 10      59      30      30      99      0       3       0       0       0        0        0.5    0      0        #  DN Peak
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0.5    0      0        #  DN Top
 0.5     8       3       3       99      0       3       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 0.01    8       7       7       99      0      -3       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -9      -10     -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0      -3       0       0       0        0        0      0      0        #  DN Final
# NoCA_OR_WA_Rec
 10      59      30      30      99      0       3       0       0       0        0        0.5    0      0        #  DN Peak
...
-12      12     10       10      99      0       3       0       0       0        0        0      0      0        #  DN Final
# TWL_discard
 10      50      30      30      99      0       3       0       0       0        0        0.5    0      0        #  DN Peak
-10      10     -6      -6       99      0      -3       0       0       0        0        0.5    0      0        #  DN Top
 0.5     8       3       3       99      0       3       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 0.01    8       5       5       99      0       3       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -10     -10     -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
...
#factor fleet New_Var_adj hash Old_Var_adj New_Francis   New_MI Francis_mult Francis_lo Francis_hi  MI_mult Type             Name                              Note
      4     1    0.459855    #    0.461854    0.459855 1.167616     0.995671   0.637298   2.295047 2.528106  len         NoCA_HKL                                  
      4     2    0.633139    #    0.630896    0.633139 3.047301     1.003555   0.688103   1.927460 4.830116  len         SoCA_HKL                                  
      4     3    0.182400    #    0.183644    0.182400 0.473095     0.993227   0.724304   1.466979 2.576155  len           CA_TWL                                  
      4     4    0.086302    #    0.086169    0.086302 0.386193     1.001542   0.589509   3.632918 4.481814  len       OR_WA_Comm                                  
      4     5    0.436571    #    0.436114    0.436571 1.593452     1.001047   0.592603   2.713814 3.653751  len           CA_NET                                  
      4     6    0.293067    #    0.293198    0.293067 0.433059     0.999553   0.500865   2.792523 1.477018  len   NoCA_OR_WA_Rec                                  
      4     7    0.138737    #    0.138025    0.138737 0.601286     1.005157   0.670329   1.786385 4.356356  len         SoCA_Rec                                  
      4     8    0.020124    #    0.020112    0.020124 0.066629     1.000587   0.653643   2.805450 3.312883  len      TWL_discard                                  
      4     9    0.029441    #    0.029386    0.029441 0.138911     1.001870   0.667696   2.208184 4.727109  len     WCGBT_Survey                                  
      4    10    0.062974    #    0.062920    0.062974 0.177224     1.000851   0.667102   8.246843 2.816663  len Triennial_Survey                                  
      5     1    0.030069    #    0.029698    0.030069 0.147691     1.012482   0.506066   5.502157 4.973089  age         NoCA_HKL                                  
      5     2    1.000000    #    1.000000  119.872312 0.358769   119.872312 119.872312        Inf 0.358769  age         SoCA_HKL                                  
      5     3    0.016228    #    0.015924    0.016228 0.024752     1.019117   0.624637   2.404755 1.554386  age           CA_TWL                                  
      5     4    1.000000    #    1.000000    5.039984 0.448570     5.039984   3.094439  27.629502 0.448570  age       OR_WA_Comm                                  
      5     5    0.063114    #    0.062492    0.063114 0.162011     1.009947   0.616909   2.545457 2.592500  age           CA_NET                                  
      5     9    0.095067    #    0.094967    0.095067 0.010247     1.001055   0.592586   3.188508 0.107902  age     WCGBT_Survey                                  
      5    10    0.005854    #    0.005867          NA 0.005854           NA         NA         NA 0.997751  age Triennial_Survey No Francis weight--using MI value
-9999  0  0   #  terminator
#
4 #_maxlambdaphase
