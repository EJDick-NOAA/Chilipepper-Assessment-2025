library(r4ss)
setwd('C:/Users/ejdick/Desktop/chili/Model abc, M116 profile h')
dir.prof <- getwd()
...
# re-run iterations 2, 4, 6, 7 from phase 1 due to failed convergence
prof.table2 <- profile(
  dir = dir.prof,
  oldctlfile = "control.ss_new",
  newctlfile = "control.ss",
...
prof.table3 <- rbind.data.frame(subset(prof.table, converged=="TRUE"), prof.table2)
