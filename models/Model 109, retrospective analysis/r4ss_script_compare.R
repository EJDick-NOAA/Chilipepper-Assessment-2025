...
library(r4ss)
model.dir <- "Model 103, compare M100 to simple selex for WCGBTS"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 100, PRE-STAR BASE hess step"
...
legend.labels <- c("WCBTS selex Lengths >9.5cm", "M100 THE DECEIVER")
