...
library(r4ss)
model.dir <- "Model 085, block trawl based on 2D results"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 084, allow domed for NET (check with hess)"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 083, M066 with h=0.72 no retuning, ~1 change in NLL"
dir4 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 066, add GMT catch projects to forecast file"
...
legend.labels <- c("Block Trawl 2000", "Domed Net Selex", "M083 (M066 with h=0.72)", "M066")
