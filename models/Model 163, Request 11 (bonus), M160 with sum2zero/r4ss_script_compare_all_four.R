...
library(r4ss)
model.dir <- "Model 163, Request 11 (bonus), M160 with sum2zero"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 160, STARbase, asymptotic"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 162, Request 11, est steepness with sum2zero"
dir4 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 161, Request 11, est steepness without sum2zero"
...
legend.labels <- c("STAR_base, sum2zero", "STAR_base, 'simple devs'", "Est. Steepness, sum=0", "Est. Steepness, simple devs")
