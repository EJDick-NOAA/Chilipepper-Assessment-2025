...
0.01   0.5  0.19        0.20        50    0       2    101          0        1978      2024      0      0     0         # VonBert_K_Fem_GP_1
...
#
# timevary MG parameters -- female k (only), male k is still an exponential offset
#LO     HI      INIT    PRIOR   PR_SD   PR_type PHASE	#Parm name
#  0     2       1       1       99      0       -99	    # P[t] in P[y] = P[base,y]*exp{dev[y]*dev[se]}
#
