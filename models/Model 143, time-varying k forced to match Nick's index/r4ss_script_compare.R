...
library(r4ss)
model.dir <- "Model 143, time-varying k forced to match Nick's index"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 136, pre-STAR base with annual k devs"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 116, pre-STAR base, no early devs, hess_step"
...
legend.labels <- c("M143 time-var. k, matches index", "M136, free annual k devs", "M116 Pre-STAR base")
