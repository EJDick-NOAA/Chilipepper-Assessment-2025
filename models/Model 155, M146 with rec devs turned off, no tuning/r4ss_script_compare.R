...
library(r4ss)
model.dir <- "Model 155, M146 with rec devs turned off, no tuning"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 146, revised pre-STAR base, hess_step"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 153, M146 with sum to zero constraint"
dir4 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 154, M153 with tuned comps and bias adjustment"
...
legend.labels <- c("pre-STAR base, no_devs_no_tuning", "pre-STAR base", "pre-STAR base, SumtoZero_no_tuning", "pre-STAR base_SumtoZero_tuned")
