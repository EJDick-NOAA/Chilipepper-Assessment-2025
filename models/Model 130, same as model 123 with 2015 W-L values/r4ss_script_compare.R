...
library(r4ss)
model.dir <- "Model 130, same as model 123 with 2015 W-L values"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 123, fix steepness and both Ms at 2015 values, compare age 1+ bio"
...
legend.labels <- c("M130=M116 with 2015 h,M,W-L", "M123=M116 with 2015 h,M new W-L")
