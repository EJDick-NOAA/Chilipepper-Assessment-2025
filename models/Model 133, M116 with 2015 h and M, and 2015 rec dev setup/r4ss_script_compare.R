...
library(r4ss)
model.dir <- "Model 133, M116 with 2015 h and M, and 2015 rec dev setup"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 117, change summary bio to age 1+ for historical comparison"
...
legend.labels <- c("M133, M116 with 2015 h+M+devs", "M1117, M116 with age1+ sumbio")
