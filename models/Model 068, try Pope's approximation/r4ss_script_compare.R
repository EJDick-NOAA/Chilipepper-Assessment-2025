...
library(r4ss)
setwd("E:/ejdick/projects/~Chilipepper 2025/model/Model 068, try Pope's approximation")

# directories where models were run need to be defined
dir1 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 066, add GMT catch projects to forecast file"
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 068, try Pope's approximation"
...
plot.dir <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 068, try Pope's approximation/plot_compare"
...
legend.labels <- c("Hybrid (iterative)","Pope's Approximation")
