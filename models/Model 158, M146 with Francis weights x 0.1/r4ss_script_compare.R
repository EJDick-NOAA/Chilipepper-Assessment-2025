...
library(r4ss)
model.dir <- "Model 158, M146 with Francis weights x 0.1"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 157, M146 with Francis weights x 0.5"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 146, revised pre-STAR base, hess_step"
...
legend.labels <- c("0.1 * Francis", "0.5 * Francis", "Francis M146")
