...
library(r4ss)
setwd('E:/ejdick/projects/~Chilipepper 2025/model/Model 181, Revised Decision Table - default HCR')
...
# pretty plots
SS_plots(replist = myreplist, plot=7, printfolder='plots_pretty',
         fleetnames = c("Hook-and-line (No. CA)",
		                "Hook-and-line (So. CA)",
		                "Trawl (CA)",
		                "Commercial gears combined (OR & WA)",
		                "Net (CA)",
		                "Recreational (North of Pt. Conception)",
		                "Recreational (South of Pt. Conception)",
		                "Trawl discards"))
