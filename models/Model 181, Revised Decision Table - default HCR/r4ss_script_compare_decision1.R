...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 182, Revised Decision Table - base model with constant MSY catch"
...
plot.dir <- paste0("E:/ejdick/projects/~Chilipepper 2025/model/",model.dir,"/plot_compare_decision1")
...
legend.labels <- c("Base Model with Default ABC=ACL Catches", "Base Model with Constant MSY Catches")

# plot comparisons
#SSplotComparisons(mod.sum, legendlabels=legend.labels, print=TRUE, plotdir=plot.dir, btarg = -1, minbthresh = -1)
SSplotComparisons(mod.sum, legendlabels=legend.labels, print=TRUE, plotdir=plot.dir, endyrvec=2036)
