...
library(r4ss)
model.dir <- "Model 181, Revised Decision Table - default HCR"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 181a, Revised Decision Table - default HCR catches, steepness 038"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 181b, Revised Decision Table - default HCR catches, steepness 097"
...
# comparison plots are saved to current model directory in subfolder identified below
plot.dir <- paste0("E:/ejdick/projects/~Chilipepper 2025/model/",model.dir,"/plot_compare_with_forecast")
...
legend.labels <- c("Base Model", "Low state of nature", "High state of nature")

# plot comparisons
#SSplotComparisons(mod.sum, legendlabels=legend.labels, print=TRUE, plotdir=plot.dir, btarg = -1, minbthresh = -1)
SSplotComparisons(mod.sum, legendlabels=legend.labels, print=TRUE, plotdir=plot.dir, endyrvec=2036, legendloc="bottomleft", ptsize = 16)
