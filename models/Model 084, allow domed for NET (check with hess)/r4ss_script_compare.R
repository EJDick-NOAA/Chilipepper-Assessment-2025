...
library(r4ss)
model.dir <- "Model 084, allow domed for NET (check with hess)"
...
dir1 <- paste0("E:/ejdick/projects/~Chilipepper 2025/model/",model.dir)

# dir2, dir3, etc. are the models being compared
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 083, M066 with h=0.72 no retuning, ~1 change in NLL"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 066, add GMT catch projects to forecast file"
...
mod.sum <- SSsummarize(list(mod1, mod2, mod3))

# legend labels and table column names
legend.labels <- c("Domed Net Selex", "M083 (M066 with h=0.72)", "M066")
