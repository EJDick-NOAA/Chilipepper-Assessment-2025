...
library(r4ss)
model.dir <- "Model 126, constant TWL selex with M116"
...
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 125, 2D selectivity with M116"
...
legend.labels <- c("M126 constant TWL selex", "M116 Pre-STAR base", "M125 2D selex")
