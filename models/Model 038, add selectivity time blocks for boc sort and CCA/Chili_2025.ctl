...
1875 2000 # CCA in So. CA (not trying to model changes in 2024 due to limited data)
...
0.01   0.2  0.1         0           50    0       2    0            0        0         0         0      0     0         # CV_old_Fem_GP_1
...
# maturity ogive
  30  50    40.36       40.36       50    0      -99   0            0        0         0         0      0     0         # Mat50%_Fem
  -1   0    -0.38061    -0.38061    50    0      -99   0            0        0         0         0      0     0         # Mat_slope_Fem
# fecundity F=aL^b; 'a' is scaled so spawning output has units of billions of eggs
   0   1    1.4067E-08  1.4067E-08  50    0      -99   0            0        0         0         0      0     0         # Eggs/kg_inter_Fem
   2   5    4.6851      4.6851      50    0      -99   0            0        0         0         0      0     0         # Eggs/kg_slope_wt_Fem
#
#########
...
-0.6   0    0           0           50    0      -2    0            0        0         0         0      0     0         # L_at_Amin_Mal_GP_1
  -1   0   -0.3         0           50    0       2    0            0        0         0         0      0     0         # L_at_Amax_Mal_GP_1
   0   1    0.4         0           50    0       2    0            0        0         0         0      0     0         # VonBert_K_Mal_GP_1
-0.5   1.5  0           0           50    0       2    0            0        0         0         0      0     0         # CV_young_Mal_GP_1
  -2   2    0           0           50    0       2    0            0        0         0         0      0     0         # CV_old_Mal_GP_1
# weight-length from WCGBTS survey data
...
8      12     10.5   10      5      0        1      0        0        0         0         0       0      0       # SR_LN(R0)
...
#   0   2     0.5   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_DWV_onboard_CPFV_observer
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 0.5     8       3       3       99      0       3       0       0       0        0        0      1      2        #  DN Ascending Scale
...
#-12      12      10      10      99      0       3       0       0       0        0        0      0      0        #  DN Final
# CA_TWL
 20      50      30      30      99      0       3       0       0       0        0        0      0      0        #  DN Peak
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 1       6       3       3       99      0       3       0       0       0        0        0      0      0        #  DN Ascending Scale
...
-12      12      10      10      99      0      -3       0       0       0        0        0      0      0        #  DN Final
# SoCA_Rec
 10      40      30      30      99      0       3       0       0       0        0        0      2      2        #  DN Peak
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 0.5     6       3       3       99      0       3       0       0       0        0        0      2      2        #  DN Ascending Scale
 0.01    8       7       5       99      0       3       0       0       0        0        0      2      2        #  DN Descending Scale
-11     -10    -10      -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-10      10      0       0       99      0       3       0       0       0        0        0      2      2        #  DN Final
# TWL_discard
...
# WCGBT_Survey
 10      59      30      30      99      0       3       0       0       0        0        0      0      0        #  DN Peak
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 0.01    10      5       3       99      0       3       0       0       0        0        0      0      0        #  DN Ascending Scale
 0.01    10      5       5       99      0       3       0       0       0        0        0      0      0        #  DN Descending Scale
-11     -10     -10     -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0       3       0       0       0        0        0      0      0        #  DN Final
# Triennial_Survey
# 10      59      30      30      99      0       3       0       0       0        0        0      0      0        #  DN Peak
...
#LO     HI      INIT    PRIOR   PR_SD   PR_type PHASE	#Parm name
 20     59.5    30      30      99      0       3	    # NoCA_HKL PEAK, block pattern 1 (1875-1990); pre-boc sort
  1     10       5      5       99      0       3	    # NoCA_HKL ASCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
  8     50      30      30      99      0       3	    # SoCA_Rec PEAK, block pattern 2 (1875-2000); CCA
 0.5    10       3      3       99      0       3	    # SoCA_Rec ASCENDING SCALE, block pattern 1 (1875-2000); CCA
 0.01    8       7      5       99      0      -3	    # SoCA_Rec DESCENDING SCALE, block pattern 1 (1875-2000); CCA
-12     12      10      0       99      0      -3	    # SoCA_Rec FINAL, block pattern 1 (1875-2000); CCA
#
...
#factor fleet New_Var_adj hash Old_Var_adj New_Francis   New_MI Francis_mult Francis_lo Francis_hi  MI_mult Type             Name                              Note
      4     1    0.544309    #    0.524856    0.544309 1.253592     1.037064   0.699565   1.966441 2.388449  len         NoCA_HKL                                  
      4     2    0.951698    #    1.000000    0.951698 4.279049     0.951698   0.670492   2.017892 4.279049  len         SoCA_HKL                                  
      4     3    0.161107    #    0.151256    0.161107 0.484230     1.065126   0.808987   1.593727 3.201396  len           CA_TWL                                  
      4     4    0.086951    #    0.087869    0.086951 0.388764     0.989551   0.584035   3.517600 4.424363  len       OR_WA_Comm                                  
      4     5    0.417257    #    0.418869    0.417257 1.670288     0.996152   0.588465   2.536032 3.987613  len           CA_NET                                  
      4     6    0.478018    #    0.475718    0.478018 0.659947     1.004835   0.710394   1.693648 1.387265  len   NoCA_OR_WA_Rec                                  
      4     7    0.171387    #    0.164161    0.171387 0.637028     1.044020   0.637534   1.970152 3.880507  len         SoCA_Rec                                  
      4     8    0.018945    #    0.019726    0.018945 0.063326     0.960420   0.614158   3.141139 3.210272  len      TWL_discard                                  
      4     9    0.027609    #    0.027248    0.027609 0.136319     1.013251   0.654066   2.245971 5.002897  len     WCGBT_Survey                                  
      4    10    0.049833    #    0.052722    0.049833 0.174735     0.945210   0.607700   5.901379 3.314264  len Triennial_Survey                                  
      5     1    0.038717    #    0.036252    0.038717 0.144354     1.067984   0.485533   6.528483 3.981952  age         NoCA_HKL                                  
      5     3    0.026528    #    0.018498    0.026528 0.009385     1.434075   0.777536   3.811314 0.507335  age           CA_TWL                                  
      5     4    1.000000    #    1.000000    4.850020 0.448456     4.850020   2.995405  28.304195 0.448456  age       OR_WA_Comm                                  
      5     5    0.086134    #    0.077296    0.086134 0.164853     1.114334   0.680131   2.839205 2.132749  age           CA_NET                                  
      5     9    0.091412    #    0.091688    0.091412 0.002065     0.996992   0.609573   2.816241 0.022520  age     WCGBT_Survey                                  
      5    10    0.005724    #    0.005400          NA 0.005724           NA         NA         NA 1.060022  age Triennial_Survey No Francis weight--using MI value
-9999  0  0   #  terminator
#
4 #_maxlambdaphase
