...
library(r4ss)
model.dir <- "Model 138, pre-STAR base, female M = male M"
...
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 127, estimate M & h with M116"
...
legend.labels <- c("h=0.72, female M = male M", "h=0.72, sex-specific M", "est. h, sex-specific M")
