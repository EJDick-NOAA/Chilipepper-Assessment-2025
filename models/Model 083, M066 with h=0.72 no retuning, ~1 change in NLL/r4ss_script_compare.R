...
library(r4ss)
model.dir <- "Model 083, M066 with h=0.72 no retuning, ~1 change in NLL"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 066, add GMT catch projects to forecast file"
...
legend.labels <- c("M083 (M066 with h=0.72)", "M066")
