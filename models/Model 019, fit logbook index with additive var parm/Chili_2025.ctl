...
#_fleet  link  link_info  extra_se  biasadj float # fleetname
      3     1          0         1        0     1 # TWL_logbook
      9     1          0         0        0     1 # WCGBT_TWL_Survey
     10     1          0         0        0     1 # Triennial_TWL_Survey
  -9999     0          0         0        0     0 # terminate
#
#_Q_parms(if_any); units_are_ln(q)
#_LO   HI   INIT   PRIOR   PR_SD   PR_type   PHASE   env-var   use_dev   dev_mnyr   dev_mxyr   dev_PH   Block   Blk_Fxn # parm_name
 -10   3    -4     0       1       0         -1      0         0         0          0          0        0       0       # ln_q_Comm_TWL_Logbook
   0   5     0.1   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_Comm_TWL_Logbook
...
#  0 0 0  0 # RREAS_YOY_Survey      # 11
#  0 0 0  0 # NWFSC_HKL_Survey      # 12
#  0 0 0  0 # CalCOFI_Survey        # 13
#
#_age_selex_types
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0.5    0      0        #  DN Top
 0.5     6       3       3       99      0       3       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 0.01    10      7       7       99      0      -3       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -9      -10     -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0      -3       0       0       0        0        0      0      0        #  DN Final
# TWL_discard
...
-10      10     -6      -6       99      0       3       0       0       0        0        0.5    0      0        #  DN Top
 ...
 0.01    10      5       5       99      0       3       0       0       0        0        0.5    0      0        #  DN Descending Scale
...
#factor fleet New_Var_adj hash Old_Var_adj New_Francis   New_MI Francis_mult Francis_lo Francis_hi  MI_mult Type                 Name Note
      4     1    0.498727    #    0.497726    0.498727 1.149206     1.002011   0.635098   1.980352 2.308913  len             NoCA_HKL     
      4     2    0.406890    #    0.402970    0.406890 2.658045     1.009728   0.658939   2.008651 6.596135  len             SoCA_HKL     
      4     3    0.168173    #    0.167872    0.168173 0.468325     1.001794   0.717637   1.543572 2.789772  len               CA_TWL     
      4     5    0.384837    #    0.387836    0.384837 1.534775     0.992267   0.565583   2.484031 3.957278  len               CA_NET     
      4     8    0.019296    #    0.019310    0.019296 0.063714     0.999274   0.679465   2.448455 3.299523  len          TWL_discard     
      4     9    0.024382    #    0.024285    0.024382 0.115459     1.004014   0.726728   1.910297 4.754333  len         WCGBT_Survey     
      4    10    0.039225    #    0.039079    0.039225 0.144235     1.003744   0.759665   2.927363 3.690864  len Triennial_TWL_Survey     
      5     9    0.052126    #    0.050960    0.052126 0.021396     1.022890   0.710264   2.108906 0.419863  age         WCGBT_Survey
-9999  0  0   #  terminator
#
4 #_maxlambdaphase
...
#_indices
1      3      1      1      1 # Commercial Trawl Logbook Index Lambda=1 (fit with extra var parameter)
1      8      1      1      1
1      9      1      1      1
#_lengths
4      1      1      1      1
