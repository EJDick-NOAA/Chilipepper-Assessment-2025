...
library(r4ss)
model.dir <- "Model 088, re-estimate domed selex"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 087, M086 + estimate steepness"
...
legend.labels <- c("M088 domed TWL selex", "M087 asymp TWL selex")
