...
#LO     HI      INIT    PRIOR   PR_SD   PR_type PHASE	#Parm name
 ...
 10     59      30     30      99      0       3	    # TWL PEAK, block pattern 1 (1875-1990); pre-boc sort
 0.01   12      3      3       99      0       3	    # TWL ASCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
 0.01   20      15     15      99      0       3	    # TWL DESCENDING SCALE, block pattern 1 (1875-1990); pre-boc sort
