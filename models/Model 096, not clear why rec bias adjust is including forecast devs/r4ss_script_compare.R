...
library(r4ss)
model.dir <- "Model 091, adjust SoCA HKL selex"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 090, fix TWL top logit (recent) and asymp (early)"
...
legend.labels <- c("M091 revised SoCA HKL selex", "M090")
