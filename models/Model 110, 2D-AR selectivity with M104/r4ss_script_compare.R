...
library(r4ss)
model.dir <- "Model 110, 2D-AR selectivity with M104" # current subdirectory
setwd(paste0("E:/ejdick/projects/~Chilipepper 2025/model/",model.dir)) # path to parent folder

dir1 <- getwd() # model in current subdirectory

# dir2, dir3, etc. are the directories for models being compared to dir1

dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 104, PRE-STAR base model, version 61, revisited"
...
# need to create the subdirectory "plot_compare" manually BEFORE making plots
...
# legend labels for plots (mod1, mod2, etc.)
legend.labels <- c("2D TWL selex", "M104 base")
