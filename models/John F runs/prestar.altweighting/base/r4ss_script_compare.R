...
library(r4ss)
model.dir <- "John F runs/prestar.altweighting/base"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/John F runs/prestar.altweighting/addreccpue"
dir3 <- "E:/ejdick/projects/~Chilipepper 2025/model/John F runs/prestar.altweighting/addtrawlcpue"
dir4 <- "E:/ejdick/projects/~Chilipepper 2025/model/John F runs/prestar.altweighting/addtrawlandrec"
dir5 <- "E:/ejdick/projects/~Chilipepper 2025/model/John F runs/prestar.altweighting/upweightCALCOFI"
dir6 <- "E:/ejdick/projects/~Chilipepper 2025/model/John F runs/prestar.altweighting/upweightWCGBTS"
#dir7 <- "E:/ejdick/projects/~Chilipepper 2025/model/John F runs/prestar.altweighting/"
...
mod6 <- SS_output(dir=dir6)
#mod7 <- SS_output(dir=dir7)

# create list summarizing model results
mod.sum <- SSsummarize(list(mod1, mod2, mod3, mod4, mod5, mod6)) #))

# legend labels and table column names
legend.labels <- c("base", "add Rec. CPUE", "add Trawl CPUE", "add Rec.+Trawl", "Upweight CalCOFI", "Upweight WCGBTS")
