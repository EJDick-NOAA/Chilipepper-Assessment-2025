...
0.01   0.6  0.16        -1.86895    0.31  3      -3    0            0        0         0         0      0     0         # NatM_p_1_Fem_GP_1
...
0.05   0.25 0.20        0.20        50    0      -2    0            0        0         0         0      0     0         # VonBert_K_Fem_GP_1
0.01   0.2  0.1         0           50    0      -3    0            0        0         0         0      0     0         # CV_young_Fem_GP_1
0.01   0.2  0.082       0           50    0      -3    0            0        0         0         0      0     0         # CV_old_Fem_GP_1
# weight-length
   0   1    1.7069e-05  1.71E-05    50    0      -9    0            0        0         0         0      0     0         # Wtlen_1_Fem
   2   4    3.01212     3.01        50    0      -9    0            0        0         0         0      0     0         # Wtlen_2_Fem
# maturity ogive
...
#
  -1   1    0           0           50    0      -3    0            0        0         0         0      0     0         # NatM_p_1_Mal_GP_1
...
# weight-length
   0   1    1.7069e-05  1.71E-05    50    0      -9    0            0        0         0         0      0     0         # Wtlen_1_Mal
   2   4    3.01212     3.01        50    0      -9    0            0        0         0         0      0     0         # Wtlen_2_Mal
...
4      30     15     11      8      0        1      0        0        0         0         0       0      0       # SR_LN(R0)
...
#_LO   HI   INIT   PRIOR   PR_SD   PR_type   PHASE   env-var   use_dev   dev_mnyr   dev_mxyr   dev_PH   Block   Blk_Fxn # parm_name
 -15   9    -5     0       1       0         2       0         0         0          0          0        0       0       # ln_q_WCGBT_TWL_Survey
 -15   9    -5     0       1       0         2       0         0         0          0          0        0       0       # ln_q_Triennial_TWL_Survey
#
...
#_Pattern Discard Male Special
 ...
 15 0 0  1 # SoCA_Rec              #  7
 15 0 0  1 # WCGBT_Survey          #  8 # survey fleets
 15 0 0  1 # Triennial_TWL_Survey  #  9
...
# NoCA_HKL
# 15      45      30      30      99      0      2       0       0       0        0        0      0      0        #  Inflection
#  1      10      2       2       99      0      2       0       0       0        0        0      0      0        #  95% width
 10      50      30      30      99      0       2       0       0       0        0        0.5    0      0        #  DN Peak
-10      10     -6      -6       99      0      -2       0       0       0        0        0.5    0      0        #  DN Top
 0.5     6       3       3       99      0       2       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 1       10      10      5       99      0      -2       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -9      -10     -10      99      0      -2       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0      -2       0       0       0        0        0      0      0        #  DN Final
# CA_TWL
 10      50      30      30      99      0       2       0       0       0        0        0.5    0      0        #  DN Peak
-10      10     -6      -6       99      0      -2       0       0       0        0        0.5    0      0        #  DN Top
 0.5     6       3       3       99      0       2       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 1       10      5       5       99      0       2       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -9      -10     -10      99      0      -2       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0       2       0       0       0        0        0      0      0        #  DN Final
# CA_NET
 10      50      30      30      99      0       2       0       0       0        0        0.5    0      0        #  DN Peak
-10      10     -6      -6       99      0       2       0       0       0        0        0.5    0      0        #  DN Top
 0.5     6       3       3       99      0       2       0       0       0        0        0.5    0      0        #  DN Ascending Scale
 0.1     10      5       5       99      0       2       0       0       0        0        0.5    0      0        #  DN Descending Scale
-11     -9      -10     -10      99      0      -2       0       0       0        0        0      0      0        #  DN Init
-12      12      10      10      99      0       2       0       0       0        0        0      0      0        #  DN Final
...
#         4     1    1           #    1.000000    1.421373 4.518571     1.421373   1.008243  10.311717 4.518571  len       Comm_nonTwl     
#         4     3    0.234816    #    0.234979    0.234816 0.562382     0.999305   0.675516   2.144339 2.393327  len      Comm_Discard     
#         4     4    0.163286    #    0.163105    0.163286 0.275410     1.001113   0.559168   3.263034 1.688543  len    Rec_PC_Central     
#         4     5    0.209433    #    0.209161    0.209433 0.184374     1.001301   0.711821   1.624712 0.881491  len    Rec_PR_Central     
#         4     6    0.407093    #    0.406678    0.407093 1.051411     1.001021   0.531058   4.057009 2.585364  len  Rec_Disc_Central     
#         4     7    0.083521    #    0.083533    0.083521 0.312206     0.999854   0.697053   2.091761 3.737515  len             CCFRP     
#         4     8    0.160752    #    0.160869    0.160752 1.237837     0.999272   0.669406   2.810181 7.694692  len  DWV_Onboard_CPFV     
#         4    13    0.201439    #    0.203090    0.201439 0.169724     0.991872   0.690975   8.502887 0.835708  len CDFG_Lea_Research     
#         5     4    0.425795    #    0.439739    0.425795 0.406466     0.968289   0.798721        Inf 0.924335  age    Rec_PC_Central     
#         5     5    0.281346    #    0.283349    0.281346 0.184166     0.992931   0.992931        Inf 0.649960  age    Rec_PR_Central     
#         5     7    0.174442    #    0.174282    0.174442 0.404646     1.000915   0.689806   5.555665 2.321789  age             CCFRP     
#         5    13    0.130897    #    0.130598    0.130897 0.334012     1.002290   0.526797 744.176158 2.557562  age CDFG_Lea_Research
-9999  0  0   #  terminator
#
9 #_maxlambdaphase
