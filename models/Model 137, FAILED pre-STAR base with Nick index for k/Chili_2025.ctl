...
1 0 0 0 1 # autogen: 1st element for biology, 2nd for SR, 3rd for Q, 4th reserved, 5th for selex
#
...
##################
# dev_link=5 --> "mean reverting random walk with ρ and a logit transformation to stay within the minimum and maximum parameter bounds"
##################
0.01   1    0.19        0.20        50    0       2    0            5        1978      2024      3      0     0         # VonBert_K_Fem_GP_1
...
#_ LO HI INIT PRIOR PR_SD PR_type  PHASE
 0.001 10 1 1 99 0 -5 # VonBert_K_Fem_GP_1_dev_se
 -0.99 0.99 0 0 99 0 -5 # VonBert_K_Fem_GP_1_dev_autocorr
#
...
1962.6694 #_last_early_yr_nobias_adj_in_MPD                   
1978.6197 #_first_yr_fullbias_adj_in_MPD                      
2022.7697 #_last_yr_fullbias_adj_in_MPD                       
2024.9990 #_first_recent_yr_nobias_adj_in_MPD                 
   0.8596 #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models)
...
#_fleet  link  link_info  extra_se  biasadj float # fleetname
     ...
     12     1          0         1        0     1 # RREAS
## link_info
	 13     5          1         0        0     0 # vonBert_k_index; link 5 --> y = Q*(x+B); I fixed x = 0, I think. Link_info indexes env dev index (only 1)
...
#   0   1     0.1   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_DWV_onboard_CPFV_observer
 ...
 -15   0    -5     0       1       0         -1      0         0         0          0          0        0       0       # ln_q_RREAS
   0   3     1.2   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_RREAS
 -15   15    0     0       1       0         -1      0         0         0          0          0        0       0       # ln_q_vonBert_k_index
 -5    5    0     0       1       0          -1      0         0         0          0          0        0       0       # additive_offset_vonBert_k_index
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 0.5     15      3       3       99      0       3       0       0       0        0        0      2      2        #  DN Ascending Scale
 0.5     20      10      10      99      0       3       0       0       0        0        0      2      2        #  DN Descending Scale
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Init
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Final
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 ...
 0.01    20      3       15      99      0       3       0       0       0        0        0      3      2        #  DN Descending Scale
-10      10     -10     -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Final
...
-10      10     -6      -6       99      0      -3       0       0       0        0        0      0      0        #  DN Top
 ...
 0.01    20      10      10      99      0      -3       0       0       0        0        0      0      0        #  DN Descending Scale
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Init
-1000   -998    -999    -999     99      0      -3       0       0       0        0        0      0      0        #  DN Final
...
#factor fleet New_Var_adj hash Old_Var_adj New_Francis   New_MI Francis_mult Francis_lo Francis_hi  MI_mult Type             Name                              Note
      4     1    0.538544    #    0.536826    0.538544 1.249785     1.003200   0.668173   1.878393 2.328101  len         NoCA_HKL                                  
      4     2    2.461050    #    2.465450    2.461050 6.145402     0.998215   0.760092   1.831934 2.492608  len         SoCA_HKL                                  
      4     3    0.244897    #    0.244571    0.244897 0.604687     1.001333   0.702233   1.629785 2.472440  len           CA_TWL                                  
      4     4    0.090563    #    0.090385    0.090563 0.388459     1.001974   0.588861   4.316864 4.297823  len       OR_WA_Comm                                  
      4     5    0.409513    #    0.409510    0.409513 1.642033     1.000008   0.576852   2.807583 4.009752  len           CA_NET                                  
      4     6    0.379803    #    0.376124    0.379803 0.566083     1.009783   0.738754   1.609503 1.505043  len   NoCA_OR_WA_Rec                                  
      4     7    0.170576    #    0.171608    0.170576 0.622194     0.993985   0.622379   1.982908 3.625668  len         SoCA_Rec                                  
      4     8    0.020600    #    0.020542    0.020600 0.067267     1.002813   0.635162   3.506902 3.274594  len      TWL_discard                                  
      4     9    0.035994    #    0.035616    0.035994 0.132900     1.010605   0.621560   2.312353 3.731466  len     WCGBT_Survey                                  
      4    10    0.058115    #    0.058686    0.058115 0.177752     0.990278   0.689944   4.293917 3.028871  len Triennial_Survey                                  
      5     1    0.030383    #    0.030630    0.030383 0.147743     0.991942   0.490680   6.298678 4.823485  age         NoCA_HKL                                  
      5     3    0.016200    #    0.016258    0.016200 0.021110     0.996455   0.590310   2.371155 1.298465  age           CA_TWL                                  
      5     4    1.000000    #    1.000000    6.907482 0.416355     6.907482   4.261739  36.044655 0.416355  age       OR_WA_Comm                                  
      5     5    0.064152    #    0.064488    0.064152 0.161423     0.994793   0.617352   2.890902 2.503149  age           CA_NET                                  
      5     6    1.000000    #    1.000000    1.704471 0.562471     1.704471   1.704471        Inf 0.562471  age   NoCA_OR_WA_Rec                                  
      5     9    0.095485    #    0.094528    0.095485 0.007682     1.010121   0.630919   3.178197 0.081266  age     WCGBT_Survey                                  
      5    10    0.116064    #    0.116059          NA 0.116064           NA         NA         NA 1.000040  age Triennial_Survey No Francis weight--using MI value
-9999  0  0   #  terminator
#
7 #_maxlambdaphase
