library(r4ss)
setwd('C:/Users/ejdick/Desktop/chili/Model YYZ, bivariate M & h profile')
dir.prof <- getwd()

par_table <- expand.grid(
  Mvec = c(0.13, 0.14, 0.15, 0.16, 0.17, 0.171052, 0.174703, 0.18, 0.19, 0.2, 0.21, 0.22),
  hvec = c(0.25, 0.3, 0.35, 0.4, 0.432765, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.72, 0.75, 0.8, 0.85, 0.9, 0.95)
)
par_table
