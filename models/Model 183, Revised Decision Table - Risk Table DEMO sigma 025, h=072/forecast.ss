...
-1 #_Flimitfraction
# buffers from get_buffers() in PEPtools package (revised, and revised again)
# PEPtools::get_buffer(2025:2036, sigma = 0.25, pstar = 0.45, m = c(0.165, 0.216), verbose = TRUE)
#The geometric mean of natural mortality values is 0.189.
#The sigma value of 0.25 adjusts yearly by the rate of 0.09828.
#year buffer
 2025  1.000
 2026  1.000
 2027  0.966
