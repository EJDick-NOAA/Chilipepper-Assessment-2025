...
library(r4ss)
model.dir <- "Model 165, M160 Request 15 part 2, remove triennial"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 165, M160 Request 15 part 1"
...
legend.labels <- c("Request 15, part 2", "Request 15, part 1", "STAR_base, asymptotic")
