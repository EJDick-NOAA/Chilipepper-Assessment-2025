...
library(r4ss)
model.dir <- "Model 184, sensitivity to larger CV for length at age 20"
...
dir2 <- "E:/ejdick/projects/~Chilipepper 2025/model/Model 167a, FINAL base model, with updated forecast buffers"
...
legend.labels <- c("larger CV at age 20", "final base")
