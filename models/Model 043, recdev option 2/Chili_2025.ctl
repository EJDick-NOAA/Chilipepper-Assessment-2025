...
8      13     11.3   10      5      0        1      0        0        0         0         0       0      0       # SR_LN(R0)
...
2 #do_recdev:  0=none; 1=devvector; 2=simple deviations
     ...
     2024 # last year of main recr_devs; forecast devs start in following year
      ...
      1979 #_first_yr_fullbias_adj_in_MPD                      
      2024 #_last_yr_fullbias_adj_in_MPD                       
      2025 #_first_recent_yr_nobias_adj_in_MPD                 
    0.8755 #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models)
...
#_fleet  link  link_info  extra_se  biasadj float # fleetname
      ...
      6     1          0         1        0     1 # DWV_onboard_CPFV_observer
...
#   0   2     0.5   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_Comm_TWL_Logbook
 -10   0    -4     0       1       0         -1      0         0         0          0          0        0       0       # ln_q_DWV_onboard_CPFV_observer
   0   0.2     0.1   0.1     1       0          1      0         0         0          0          0        0       0       # add_var_DWV_onboard_CPFV_observer
...
-11     -10    -10      -10      99      0      -3       0       0       0        0        0      0      0        #  DN Init
-12     12      10       0       99      0       3       0       0       0        0        0      2      2        #  DN Final
# TWL_discard
...
#factor fleet New_Var_adj hash Old_Var_adj New_Francis   New_MI Francis_mult Francis_lo Francis_hi  MI_mult Type             Name                              Note
      4     1    0.523589    #    0.535873    0.523589 1.185010     0.977076   0.642270   1.768234 2.211363  len         NoCA_HKL                                  
      4     2    1.000000    #    0.976072    1.024606 4.308063     1.049723   0.727907   2.189156 4.413673  len         SoCA_HKL                                  
      4     3    0.149510    #    0.156732    0.149510 0.445444     0.953924   0.721887   1.411927 2.842072  len           CA_TWL                                  
      4     4    0.089128    #    0.087408    0.089128 0.388677     1.019678   0.579450   3.880781 4.446700  len       OR_WA_Comm                                  
      4     5    0.425426    #    0.422451    0.425426 1.591824     1.007042   0.596363   2.637536 3.768067  len           CA_NET                                  
      4     6    0.466425    #    0.464511    0.466425 0.651191     1.004121   0.709182   1.726989 1.401885  len   NoCA_OR_WA_Rec                                  
      4     7    0.167543    #    0.171271    0.167543 0.699718     0.978235   0.598836   2.114152 4.085446  len         SoCA_Rec                                  
      4     8    0.020387    #    0.019744    0.020387 0.065725     1.032567   0.683786   3.329934 3.328859  len      TWL_discard                                  
      4     9    0.033228    #    0.033565    0.033228 0.137601     0.989957   0.619234   2.048118 4.099528  len     WCGBT_Survey                                  
      4    10    0.046334    #    0.044958    0.046334 0.167370     1.030610   0.708562   3.371064 3.722800  len Triennial_Survey                                  
      5     1    0.036671    #    0.038675    0.036671 0.148335     0.948184   0.447940   6.306498 3.835423  age         NoCA_HKL                                  
      5     3    0.020250    #    0.026233    0.020250 0.024314     0.771937   0.455964   1.846568 0.926844  age           CA_TWL                                  
      5     4    1.000000    #    1.000000    4.412971 0.446726     4.412971   2.640622  24.956608 0.446726  age       OR_WA_Comm                                  
      5     5    0.077534    #    0.086187    0.077534 0.163100     0.899598   0.550146   2.820922 1.892394  age           CA_NET                                  
      5     6    1.240149    #    0.564049    1.240149 0.593736     2.198655   2.198655        Inf 1.052633  age   NoCA_OR_WA_Rec                                  
      5     9    0.089008    #    0.088068    0.089008 0.005479     1.010668   0.629485   3.583488 0.062214  age     WCGBT_Survey                                  
      5    10    0.005871    #    0.006206          NA 0.005871           NA         NA         NA 0.946049  age Triennial_Survey No Francis weight--using MI value
-9999  0  0   #  terminator
#
4 #_maxlambdaphase
